...
# Практика 2: фильтр по возрасту
#  1. Добавьте поле возраста пользователя
#  2. Добавьте возможность передать search-параметры 
#     min_age, max_age
#  3. Если они заданы, то выводятся только юзеры в диапазоне
#     если не задан любой из параметров, то этот фильтр 
#     не применяется
